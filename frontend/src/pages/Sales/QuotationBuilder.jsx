...
const QuotationBuilder = () => {
  ...
  const columns = [{ header: 'Quote No', accessor: 'quoteNumber' }, { header: 'Client', accessor: 'clientId' }, { header: 'System Size', accessor: 'systemSize' }, { header: 'Total Value', accessor: 'totalQuoteValue', type: 'currency' }, { header: 'Status', accessor: 'status', type: 'badge' }];
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal isOpen={modalOpen} onClose={() => { setModalOpen(false); setEditingId(null); }}
        title={editingId ? 'Edit Quotation Builder' : 'Add Quotation Builder'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-gray-500 text-center py-8">Form fields for Quotation Builder - Add your fields here</p>
