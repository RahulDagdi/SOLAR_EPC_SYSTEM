...
const PaymentReceipts = () => {
  ...
  const columns = [{ header: 'Receipt No', accessor: 'receiptNumber' }, { header: 'Invoice', accessor: 'invoiceId' }, { header: 'Client', accessor: 'clientId' }, { header: 'Amount', accessor: 'amountReceived', type: 'currency' }, { header: 'Mode', accessor: 'paymentMode' }, { header: 'Date', accessor: 'paymentDate', type: 'date' }];
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal isOpen={modalOpen} onClose={() => { setModalOpen(false); setEditingId(null); }}
        title={editingId ? 'Edit Payment Receipts' : 'Add Payment Receipts'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-gray-500 text-center py-8">Form fields for Payment Receipts - Add your fields here</p>
