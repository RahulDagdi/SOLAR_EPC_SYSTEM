...
const AttendanceLeave = () => {
  ...
  const columns = [{ header: 'Employee', accessor: 'employeeId' }, { header: 'Date', accessor: 'date', type: 'date' }, { header: 'Status', accessor: 'status', type: 'badge' }, { header: 'Check In', accessor: 'checkInTime' }, { header: 'Check Out', accessor: 'checkOutTime' }, { header: 'Hours', accessor: 'workHours' }];
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal isOpen={modalOpen} onClose={() => { setModalOpen(false); setEditingId(null); }}
        title={editingId ? 'Edit Attendance & Leave' : 'Add Attendance & Leave'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-gray-500 text-center py-8">Form fields for Attendance & Leave - Add your fields here</p>
