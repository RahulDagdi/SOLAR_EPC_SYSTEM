...
const Performance = () => {
  ...
  const columns = [{ header: 'Employee', accessor: 'employeeId' }, { header: 'Period', accessor: 'reviewPeriod' }, { header: 'Quality', accessor: 'ratings.qualityOfWork' }, { header: 'Punctuality', accessor: 'ratings.punctuality' }, { header: 'Overall', accessor: 'ratings.overallRating' }, { header: 'Reviewer', accessor: 'reviewerId' }];
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal isOpen={modalOpen} onClose={() => { setModalOpen(false); setEditingId(null); }}
        title={editingId ? 'Edit Performance Management' : 'Add Performance Management'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-gray-500 text-center py-8">Form fields for Performance Management - Add your fields here</p>
