...
const EmployeeMaster = () => {
  ...
  const columns = [{ header: 'Employee ID', accessor: 'employeeId' }, { header: 'Name', accessor: 'name' }, { header: 'Role', accessor: 'role' }, { header: 'Department', accessor: 'department' }, { header: 'Phone', accessor: 'phone' }, { header: 'DOJ', accessor: 'dateOfJoining', type: 'date' }, { header: 'Status', accessor: 'isActive', type: 'badge' }];
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal isOpen={modalOpen} onClose={() => { setModalOpen(false); setEditingId(null); }}
        title={editingId ? 'Edit Employee Master' : 'Add Employee Master'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-gray-500 text-center py-8">Form fields for Employee Master - Add your fields here</p>
