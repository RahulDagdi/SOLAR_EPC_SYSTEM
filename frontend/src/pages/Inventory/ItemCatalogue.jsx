...
const ItemCatalogue = () => {
  ...
  const columns = [{ header: 'Item Code', accessor: 'itemCode' }, { header: 'Item Name', accessor: 'itemName' }, { header: 'Category', accessor: 'category', type: 'badge' }, { header: 'Unit', accessor: 'unit' }, { header: 'HSN', accessor: 'hsnCode' }, { header: 'GST %', accessor: 'gstPercentage' }];
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal isOpen={modalOpen} onClose={() => { setModalOpen(false); setEditingId(null); }}
        title={editingId ? 'Edit Item Catalogue' : 'Add Item Catalogue'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-gray-500 text-center py-8">Form fields for Item Catalogue - Add your fields here</p>
