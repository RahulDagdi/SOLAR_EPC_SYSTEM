...
const AnnualContracts = () => {
  ...
  const columns = [{ header: 'Supplier', accessor: 'supplierName' }, { header: 'Item', accessor: 'itemId' }, { header: 'Rate', accessor: 'agreedRate', type: 'currency' }, { header: 'Start', accessor: 'contractStartDate', type: 'date' }, { header: 'End', accessor: 'contractEndDate', type: 'date' }, { header: 'Status', accessor: 'status', type: 'badge' }];
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal isOpen={modalOpen} onClose={() => { setModalOpen(false); setEditingId(null); }}
        title={editingId ? 'Edit Annual Contracts' : 'Add Annual Contracts'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-gray-500 text-center py-8">Form fields for Annual Contracts - Add your fields here</p>
