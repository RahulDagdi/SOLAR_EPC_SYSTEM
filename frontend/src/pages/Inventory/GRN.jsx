...
const GRN = () => {
  ...
  const columns = [{ header: 'GRN Number', accessor: 'grnNumber' }, { header: 'PO No', accessor: 'purchaseOrderNo' }, { header: 'Supplier', accessor: 'supplierName' }, { header: 'Warehouse', accessor: 'warehouseLocation' }, { header: 'Date', accessor: 'receivedDate', type: 'date' }];
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal isOpen={modalOpen} onClose={() => { setModalOpen(false); setEditingId(null); }}
        title={editingId ? 'Edit Goods Receipt Note' : 'Add Goods Receipt Note'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-gray-500 text-center py-8">Form fields for Goods Receipt Note - Add your fields here</p>
