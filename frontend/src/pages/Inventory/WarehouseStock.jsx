...
const WarehouseStock = () => {
  ...
  const columns = [{ header: 'Item', accessor: 'itemId' }, { header: 'Location', accessor: 'warehouseLocation' }, { header: 'Opening', accessor: 'openingStock' }, { header: 'Received', accessor: 'totalReceived' }, { header: 'Dispatched', accessor: 'totalDispatched' }, { header: 'Balance', accessor: 'closingBalance' }, { header: 'Alert', accessor: 'alertStatus', type: 'badge' }];
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal isOpen={modalOpen} onClose={() => { setModalOpen(false); setEditingId(null); }}
        title={editingId ? 'Edit Warehouse Stock' : 'Add Warehouse Stock'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-gray-500 text-center py-8">Form fields for Warehouse Stock - Add your fields here</p>
