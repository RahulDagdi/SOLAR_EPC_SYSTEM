...
const ConsumptionLog = () => {
  ...
  const columns = [{ header: 'Project', accessor: 'projectId' }, { header: 'Item', accessor: 'itemId' }, { header: 'Quantity', accessor: 'quantityUsed' }, { header: 'Purpose', accessor: 'purpose' }, { header: 'Logged By', accessor: 'loggedBy' }, { header: 'Date', accessor: 'date', type: 'date' }];
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal isOpen={modalOpen} onClose={() => { setModalOpen(false); setEditingId(null); }}
        title={editingId ? 'Edit Consumption Log' : 'Add Consumption Log'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-gray-500 text-center py-8">Form fields for Consumption Log - Add your fields here</p>
