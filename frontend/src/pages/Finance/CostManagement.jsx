...
const CostManagement = () => {
  ...
  const columns = [{ header: 'Project', accessor: 'projectId' }, { header: 'Category', accessor: 'costCategory', type: 'badge' }, { header: 'Description', accessor: 'description' }, { header: 'Amount', accessor: 'amount', type: 'currency' }, { header: 'Date', accessor: 'date', type: 'date' }, { header: 'Vendor', accessor: 'vendorId' }];
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal isOpen={modalOpen} onClose={() => { setModalOpen(false); setEditingId(null); }}
        title={editingId ? 'Edit Cost Management' : 'Add Cost Management'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-gray-500 text-center py-8">Form fields for Cost Management - Add your fields here</p>
