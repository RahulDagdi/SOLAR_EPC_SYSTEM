...
const CostOverrunAlerts = () => {
  ...
  const columns = [{ header: 'Project', accessor: 'projectId' }, { header: 'Budget', accessor: 'budgetAmount', type: 'currency' }, { header: 'Actual Cost', accessor: 'actualCost', type: 'currency' }, { header: 'Overrun', accessor: 'overrunAmount', type: 'currency' }, { header: 'Overrun %', accessor: 'overrunPercent' }, { header: 'Alert Date', accessor: 'alertDate', type: 'date' }];
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal isOpen={modalOpen} onClose={() => { setModalOpen(false); setEditingId(null); }}
        title={editingId ? 'Edit Cost Overrun Alerts' : 'Add Cost Overrun Alerts'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-gray-500 text-center py-8">Form fields for Cost Overrun Alerts - Add your fields here</p>
...
export default CostOverrunAlerts;
