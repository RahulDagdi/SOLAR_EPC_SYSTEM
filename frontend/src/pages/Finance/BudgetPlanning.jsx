...
const BudgetPlanning = () => {
  ...
  const columns = [{ header: 'Project', accessor: 'projectId' }, { header: 'PO Value', accessor: 'poValue', type: 'currency' }, { header: 'Total Budget', accessor: 'totalBudget', type: 'currency' }, { header: 'Materials', accessor: 'materialsBudget', type: 'currency' }, { header: 'Labour', accessor: 'labourBudget', type: 'currency' }, { header: 'Status', accessor: 'status', type: 'badge' }];
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal isOpen={modalOpen} onClose={() => { setModalOpen(false); setEditingId(null); }}
        title={editingId ? 'Edit Budget Planning' : 'Add Budget Planning'} size="lg">
        <form onSubmit={handleSubmit} className="space-y-4">
          <p className="text-gray-500 text-center py-8">Form fields for Budget Planning - Add your fields here</p>
